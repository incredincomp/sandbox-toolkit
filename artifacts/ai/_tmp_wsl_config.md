...
gitcommit: https://github.com/MicrosoftDocs/WSL/blob/f634e9a7c69fa53300f72e8680f92ab129c89f37/WSL/wsl-config.md
git_commit_id: f634e9a7c69fa53300f72e8680f92ab129c89f37
site_name: Docs
depot_name: WS.wsl
...
platformId: 217cb7e3-3b14-fce2-8728-2aa20524a9bc
---
...
Currently, all `.wslconfig` settings apply only to WSL 2 distributions. Learn [how to check which version of WSL you are running](install#check-which-version-of-wsl-you-are-running).
...
| `case` | Determines directories treated as case sensitive and whether new directories created with WSL will have the flag set. See [case sensitivity](case-sensitivity) for a detailed explanation of the options. Options include `off`, `dir`, or `force`. | `off` |
...
It is recommended to modify WSL configurations directly in WSL Settings, rather than manually editing the .wslconfig file. WSL Settings can be found in the Start menu. ![Windows Subsystem for Linux Settings](media/wsl-settings.png)
